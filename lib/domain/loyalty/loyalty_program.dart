...
/// The venue's loyalty program: how spend turns into points plus the reward
...
class LoyaltyProgram {
  ...
  LoyaltyProgram copyWith({int? pointsPerMajorUnit, List<RewardTier>? tiers}) =>
      LoyaltyProgram(
        pointsPerMajorUnit: pointsPerMajorUnit ?? this.pointsPerMajorUnit,
