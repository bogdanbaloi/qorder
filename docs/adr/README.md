...
| [0049](0049-venue-config-source.md) | Venue config resolved through a source port (multi-tenant seam) | Config de local rezolvat printr-un port sursă (seam multi-tenant) |
| [0050](0050-venue-from-link.md) | Venue resolved from the deep link (`/v/:venue/t/:table`) | Local rezolvat din deep link (`/v/:local/t/:masa`) |
